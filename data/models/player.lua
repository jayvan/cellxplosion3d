...
rightShoulder:add_keyframe(0.0, -20.0, 0.0)
rightShoulder:add_keyframe(0.3, 5.0, 0.0)
rightShoulder:add_keyframe(0.6, -20.0, 0.0)

rightarm = gr.sphere('rightarm')
rightShoulder:add_child(rightarm)
rightarm:set_material(black_cloth)
...
rightElbow:add_keyframe(0.0, -20.0, 0.0)
rightElbow:add_keyframe(0.3, 5.0, 0.0)
rightElbow:add_keyframe(0.6, -20.0, 0.0)
...
leftShoulder:add_keyframe(0.0, 5.0, 0.0)
leftShoulder:add_keyframe(0.3, -20.0, 0.0)
leftShoulder:add_keyframe(0.6, 5.0, 0.0)

leftarm = gr.sphere('leftarm')
leftShoulder:add_child(leftarm)
leftarm:set_material(black_cloth)
...
leftElbow:add_keyframe(0.0, 5.0, 0.0)
leftElbow:add_keyframe(0.3, -20.0, 0.0)
leftElbow:add_keyframe(0.6, 5.0, 0.0)
...
righthip:add_keyframe(0.0, 35.0, 0.0)
righthip:add_keyframe(0.3, -35.0, 0.0)
righthip:add_keyframe(0.6, 35.0, 0.0)

rightThigh = gr.sphere('rightThigh')
righthip:add_child(rightThigh)
rightThigh:set_material(black_cloth)
...
lefthip:add_keyframe(0.0, -35.0, 0.0)
lefthip:add_keyframe(0.3, 35.0, 0.0)
lefthip:add_keyframe(0.6, -35.0, 0.0)

leftThigh = gr.sphere('leftThigh')
lefthip:add_child(leftThigh)
leftThigh:set_material(black_cloth)
